        ...
        <div className="p-6 mt-32 sm:px-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <motion.div
                    ...
                    <div className='flex gap-8'>
                        <p>Thương hiệu: <span className='text-[#00579D] uppercase'></span></p>
                        <p>Tình trạng: <span className='text-[#00579D]'>{products?.status}</span></p>
                    </div>
                    <p className="text-4xl font-semibold mt-2 text-[#EF1104]">{products?.price.toLocaleString("vi-VN")}₫</p>
                    {/* <p><span className="mb-2 font-semibold">Chất liệu:</span> {products.material?.join(", ") || "Không có thông tin"}</p>
                    {products.packaging && <p><span className="mb-2 font-semibold">Đóng gói:</span> {products.packaging}</p>} */}

                    {/* Nếu API có variants, hiển thị variants */}
