...
import { Calendar, Plus, EyeOff } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="releaseDate" type="datetime-local" value={formData.releaseDate} onChange={(e) => setFormData({ ...formData, releaseDate: e.target.value })} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Textarea id="probabilityConfig" rows={2} value={formData.probabilityConfig} onChange={(e) => setFormData({ ...formData, probabilityConfig: e.target.value })} />
            </div>
